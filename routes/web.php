...
Route::post('/get_qty/' ,'PageController@get_qty');
Route::post('/get_qty_after_buy' ,'PageController@get_qty_after_buy');
...
//Route::post('/minqty/' , 'CartController@minQty');
...
//Route::post('/product_qty' , 'PageController@productQty')->middleware('auth');
