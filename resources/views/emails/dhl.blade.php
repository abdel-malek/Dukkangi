...
<img src="http://ec2-34-223-221-255.us-west-2.compute.amazonaws.com/emails/email.png" alt="@" width="42px" height="42px" ><span class="glyphicon glyphicon-envelope"></span>
...
<div class="border">
		<div class="text first">
			...
			<p>Order DHL Tracking Information.</p><br>
			<br>
			<br>

			<p>Your Order is <i>On Delivery</i>. </p>
			<p>DHL Code : {{$code}} </p>
			<p>You will get the order in 48 Hours.</p>
		</div>
		<br>
</div>
