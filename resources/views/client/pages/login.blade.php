                        ...
                        <div class="col-md-12 col-xs-12 div_login">
                            <div class="col-sm-12 my-1" style="margin-top: 19em !important;float: left;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input_login" id="inlineFormInputGroupUsername" placeholder="@lang('Username')">
                                </div>
                            </div>
                            <div class="col-sm-12 my-1" style="margin-top: 0.5em !important;float: left;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control input_login" id="inlineFormInputGroupUsername" placeholder="@lang('Password')">
                                </div>
                            </div>
